...
До роботи додано скріншоти, які демонструють:

1. Вкладку **Код** з полем введення коду, підсвіткою синтаксису та результатом аналізу.
2. Вкладку **Статистика** з метриками, історією повідомлень і таблицею snippets.
3. Вкладку **Чат** з відповіддю агента щодо збережених snippets.
4. Sidebar з відкритою колекцією snippets через `st.expander()`.
